...
<table>
	...
	<tr>
		<td>
			...
			rows="5" cols="22" value="${hojaInstance.requisitos?.getAt(0)?.otro}" 
		...
		<td>
			...
			<g:textArea name="requisito" id="requisitoSalud"  rows="5" cols="22" value="${hojaInstance.requisitos?.getAt(1)?.otro}" 
